...
CatEars.Parent =  game.Workspace
while game.Workspace:FindFirstChild('SeekMoving') do
CatEars:PivotTo(game.Workspace['SeekMoving']['SeekRig']:FindFirstChild('Head'):GetPivot()+ Vector3.new(0,0.65,0))
task.wait()
end
end
end)()
end
game.Workspace.ChildAdded:Connect(function(ins)
if ins.Name == 'SeekMoving' then
findHead(ins,'Head')
end
end)
